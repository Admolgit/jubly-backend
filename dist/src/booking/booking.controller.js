...
let BookingController = class BookingController {
    ...
    async getAdminBookings(page = '1', limit = '10', search, dateFilter, date, status) {
        return this.bookingService.getAdminBookings(page, limit, search, dateFilter, date, status);
    }
